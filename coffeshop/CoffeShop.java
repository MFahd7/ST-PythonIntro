...
public class CoffeShop {
    public static void main(String[] args) {
        ...
        CoffeeShop obj = new CoffeeShop("My Coffee Shop", menu);

        obj.addOrder("Coffee");    // adds "Coffee" to the orders
        obj.addOrder("Smoothie");  // prints "This item is currently unavailable!"
        obj.fulfillOrder();        // prints "The Coffee is ready!"
        obj.fulfillOrder();        // prints "All orders have been fulfilled!"
        System.out.println(obj.listOrders());  // returns []
        obj.addOrder("Tea");       // adds "Tea" to the orders
        obj.addOrder("Sandwich");  // adds "Sandwich" to the orders
        System.out.println(obj.dueAmount());
        
        obj.dueAmount();  //no new orders taken
        obj.cheapestItem();  
        
        obj.drinksOnly(); // all drinks
        obj.foodOnly();  // all foods
    }
}
